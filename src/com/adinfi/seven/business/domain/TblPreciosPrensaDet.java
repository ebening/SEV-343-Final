...
/**
 * TblPreciosPrensaDet generated by hbm2java
 */
public class TblPreciosPrensaDet  implements java.io.Serializable {


     private int idPrecPrensaDet;
     private TblPreciosPrensa tblPreciosPrensa;
    ...
    public TblPreciosPrensaDet() {
    }

	
    public TblPreciosPrensaDet(int idPrecPrensaDet, TblPreciosPrensa tblPreciosPrensa, int idSistemaVenta, String idSku) {
        this.idPrecPrensaDet = idPrecPrensaDet;
        this.tblPreciosPrensa = tblPreciosPrensa;
        this.idSistemaVenta = idSistemaVenta;
        this.idSku = idSku;
    }
    public TblPreciosPrensaDet(int idPrecPrensaDet, TblPreciosPrensa tblPreciosPrensa, int idSistemaVenta, String idSku, BigDecimal cdoPublicar, BigDecimal absem6mes, BigDecimal absem9mes, BigDecimal absem12mes, BigDecimal absem15mes, BigDecimal absem18mes, BigDecimal absem24mes) {
       this.idPrecPrensaDet = idPrecPrensaDet;
       this.tblPreciosPrensa = tblPreciosPrensa;
       this.idSistemaVenta = idSistemaVenta;
       this.idSku = idSku;
    ...
    public int getIdPrecPrensaDet() {
        return this.idPrecPrensaDet;
    }
    
    public void setIdPrecPrensaDet(int idPrecPrensaDet) {
        this.idPrecPrensaDet = idPrecPrensaDet;
    }
    public TblPreciosPrensa getTblPreciosPrensa() {
        return this.tblPreciosPrensa;
    }
    
    public void setTblPreciosPrensa(TblPreciosPrensa tblPreciosPrensa) {
        this.tblPreciosPrensa = tblPreciosPrensa;
    }
