...
@FacesConverter(forClass = NegocioDTO.class)
public class NegocioConverter implements Converter, Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 680219876351570969L;
	...
	public Object getAsObject(FacesContext facesContext, UIComponent component,
		...
		return controller.getNegocio(getKey(value));
	}
	...
	public String getAsString(FacesContext facesContext, UIComponent component,
		...
		if (object instanceof NegocioDTO) {
			NegocioDTO o = (NegocioDTO) object;
			return getStringKey(o.getId());
		} else {
			throw new IllegalArgumentException("object " + object
					+ " is of type " + object.getClass().getName()
					+ "; expected type: " + NegocioDTO.class.getName());
		}
	}
}