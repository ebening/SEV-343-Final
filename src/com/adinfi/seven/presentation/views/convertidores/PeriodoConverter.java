...
@FacesConverter(forClass = PeriodoDTO.class)
public class PeriodoConverter implements Converter, Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -5232689967137339948L;
	...
	public String getAsString(FacesContext facesContext, UIComponent component,
		...
		if (object instanceof PeriodoDTO) {
			PeriodoDTO o = (PeriodoDTO) object;
			return getStringKey(o.getId());
		} else {
			throw new IllegalArgumentException("object " + object
					+ " is of type " + object.getClass().getName()
					+ "; expected type: " + PeriodoDTO.class.getName());
		}
	}
}