...
@FacesConverter(value= "tipoMedioConverter")
public class CatTipoMedioConverter implements Converter, Serializable {
	...
	public Object getAsObject(FacesContext facesContext, UIComponent component,
		...
		return controller.getTipoMedio(getKey(value));
	}
	...
	public String getAsString(FacesContext facesContext, UIComponent component,
		...
		if (object instanceof CatTipoMedioDTO) {
			CatTipoMedioDTO o = (CatTipoMedioDTO) object;
			return getStringKey(o.getId());
		} else {
			throw new IllegalArgumentException("object " + object
					+ " is of type " + object.getClass().getName()
					+ "; expected type: " + CatTipoMedioDTO.class.getName());
		}
	}
}
